...
**B.Sc. Computer Engineering (Software Engineering)** — Islamic Azad University, Najafabad
Thesis: e-commerce platform optimization using Python, SQL and ML-based customer segmentation — **~4% revenue increase, ~7% efficiency improvement**.

---

## 🌍 Languages
German (B2) · English (Fluent) · Persian (Native)
